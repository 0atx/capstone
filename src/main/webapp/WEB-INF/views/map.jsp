...
<body>
	...
	<div id="wrap_all_Conents" class="container-fluid">
		<!-- 네비바 MENU 드롭 다운 버튼 중 피드백 버튼 클릭시 팝업되는 div  -->
		...
		<div class="leftMap" id="plan_wrap">
			<div class="cal">
				...
				<div class="ui-grid-b">
					<div class="ui-block-a"
						...
						<span style="padding-right: 5px;">출발</span> <input type="text"
							id="datepicker" readonly="readonly"
							style="width: 110px; height: 25px; margin-bottom: 10px;"><i
							class="fas fa-plane-departure" style="margin-left: 10px;"></i>
					</div>
					<div class="ui-block-b"
						style="text-align: left; margin-left: 15px;">
						<span style="padding-right: 5px;">도착</span> <input type="text"
							id="datepicker2" readonly="readonly"
							style="width: 110px; height: 25px; margin-bottom: 10px;"><i
							class="fas fa-plane-departure"
							style="margin-left: 10px; -ms-transform: rotate(-18deg); /* IE 9 */ transform: rotate(90deg); -moz-transform: scaleX(-1); -o-transform: scaleX(-1); -webkit-transform: scaleX(-1); transform: scaleX(-1);"></i>
					</div>
				</div>
			</div>
			...
			<div class="selectedSpots">
				...
				<div style="margin-bottom: 10px">
					<i class="fas fa-stopwatch"></i> <span class="totalDay"><span>총
							여행일수 : </span></span><br>
				</div>
		...
		<div id="modal" class="emailModal">
			<div class="email-modal-content">
				...
				<hr>
				<label class="position-left"> <h7> <b data-langnum="53">이메일</b>
					<!-- 메일 다중 전송 설정 버튼 --> <!--
				...
				<div class="emailForm">
					<input type="email" id="email" name="emailAddress"
						data-attrnum="21" maxlength="100" autocomplete="off" required>
		...
		<div id="dupModal" class="emailDupModal">
			<div class="email-dup-modal-content">
				...
				<hr>
				<label class="position-left"> <h7> <b data-langnum="53">이미
						일정이 존재하는 이메일입니다. 기존 일정을 삭제 후 저장하거나 다른 이메일을 입력해주세요.</b> </h7>
				</label> <br>
				<div class="modalSaveBtn d-grid gap-2">
					<div class="row" style="margin: 8px 5px 8px 5px;">
						<button class="btn btn-primary" onclick="deleteAndSave()"
							id="savePlanBtn">
							<div>
								<i class="far fa-envelope"></i><br>
								<h7 data-langnum="54">기존 일정 삭제 후 저장</h7>
							</div>
						</button>
					</div>
					<div class="row" style="margin: 8px 5px 8px 5px;">
						<button class="btn btn-danger" onclick="returnShowModal()"
							id="returnPlanBtn">
							<div>
								<i class="fas fa-sign-out-alt"></i><br>
								<h7 data-langnum="54">다른 이메일 입력하기</h7>
							</div>
						</button>
					</div>
				</div>
	...
	<script src="${pageContext.request.contextPath}/resources/js/save.js"></script>
